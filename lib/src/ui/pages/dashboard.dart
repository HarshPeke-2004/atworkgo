...
import 'package:atworkgo/src/ui/constants/dashboard_tile_info.dart';
import 'package:atworkgo/src/ui/pages/profile_page.dart';
import 'package:atworkgo/src/ui/widgets/dashboard_tile.dart';
...
class Dashboard extends StatefulWidget {
  ...
  Dashboard({required this.controller, this.auth, required this.user});
...
class _DashboardState extends State<Dashboard> {
  ...
  Widget bothPanels(BuildContext context, BoxConstraints constraints) {
    return new Container(
      child: new Stack(
        children: <Widget>[
          new NavigationPanel(user: widget.user),
      ...
      child: Padding(
        ...
        child: MasonryGridView.count(
          ...
          itemBuilder: (context, index) {
            ...
            return buildTile(tile[0], tile[1], tile[2], context, user, tile[3]);
          },
        ),
      ),
    );
              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.done:
                  ...
                  return Stack(
                    children: [
                      drawerTile(
                        "Allocated Location: ${snapshot.data}",
                        () {},
                        Icons.location_on,
                      ),
                    ],
